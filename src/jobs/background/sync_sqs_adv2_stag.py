...
class SyncSqsAdv2Stag(AppBase):
    def __init__(self, config):
        ...
        self.postgres_conf = self.get_param_config(['db', 'postgres_stag'])
            ...
            for queue in queues:
                ...
                for e in response:
                    try:
                        ...
                        k = {
                            "https://sqs.ap-southeast-1.amazonaws.com/985597616120/sqs-sv-dp-staging-job": 'job',
                            ...
                            "https://sqs.ap-southeast-1.amazonaws.com/985597616120/sqs-sv-dp-staging-employer": 'employer',
