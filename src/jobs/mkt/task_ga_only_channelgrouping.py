...
class TaskGaOnlyChannelgrouping(AppBase):
    ...
    def get_channelGrouping_metrics_by_channel(self,channel_name, start_date, end_date):
        ...
        for df in df_lst:
            df_base = pd.merge(df_base, df, how='left', on=['ga:channelGrouping'])
    ...
    def transform_to_ga_metrics_schema(self, df):
        ...
        rs_df = rs_df[['channelGrouping','metric_name','metric_value','channel_name','date_start']]
