...
class TaskCentralizeInputLoadingSelectUblv2(AppBase):

    def __init__(self, config):
        super(TaskCentralizeInputLoadingSelectUblv2, self).__init__(config)
        ...
        self.from_to = self.to_date.replace(minute=0, second=0, microsecond=0)
